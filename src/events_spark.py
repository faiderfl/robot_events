...
def process_hourly_sorting_aggregate(dates_sequence,operating_seconds,blocked_seconds,downtime_seconds,sort_attempts_count,sort_attempts_complete_count,unload_items_count):
...
def main():
  ...
  orb_site_machines = get_orb_site_machines()

  dates_sequence = dates_sequence.crossJoin(orb_site_machines)
  operating_seconds, blocked_seconds, downtime_seconds = get_sorting_states()
  sort_attempts_count, sort_attempts_complete_count = get_sort_attempts()
  unload_items_count = get_unloads()
  hourly_sorting_aggregate = process_hourly_sorting_aggregate(dates_sequence,operating_seconds,blocked_seconds,downtime_seconds,sort_attempts_count,sort_attempts_complete_count,unload_items_count)
